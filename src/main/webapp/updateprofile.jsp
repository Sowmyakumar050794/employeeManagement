					...
					<td>
						<fieldset>
							...
							<table width="500">
								...
								<tr>
									<td>First Name</td>
									<td><input type="text" name="fname" *="Enter first
										name" required="required" /></td>
								</tr>
								<tr>
									<td>Last Name</td>
							...
							<table width="500">
								...
								<tr>
									...
									<td><input type="email" name="email"
										placeholder="Enter E-Mail Address" required="required" /></td>
								</tr>
								<tr>
									<td>Date Of Birth</td>
									<td><input type="date" name="DOB"
										placeholder="Enter date of birth" required="required" /></td>
								</tr>
							</table>
						</fieldset>
					</td>
							...
							<table width="500">
								<tr>
									...
									<td><input type="text" name="last_comp"
										placeholder="Enter Last company Name" /></td>
								</tr>
								<tr>
									<td>Experience</td>
							...
							<table width="500">
								<tr>
									...
									<td><input type="date" name="date_of_join"
										placeholder="Enter date of join" required="required" /></td>
								</tr>
								<tr>
									<td>Designation</td>
									<td><input type="text" name="designation"
										placeholder="Enter designation" required="required" /></td>
								</tr>
								<tr>
									<td>CTC</td>
